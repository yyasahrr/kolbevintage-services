...
export const MODULES: readonly ModuleDefinition[] = [
  ...
  {
    // Phase 5.6 — operational production extension of the canonical supplier child order.
    // Production owns only its operational evidence; owner domains remain authoritative.
    name: "production",
    tables: [
      "production_job",
