...
export const ANALYTICS_METRICS: readonly AnalyticsMetricDefinition[] = [
  ...
  metric("vip.active_memberships_count", "Active VIP memberships", "Wholesale memberships active at query time for the authenticated or explicitly authorized account.", "vip", "COUNT", "One wholesale_membership row", "VIP", ["wholesale_membership"], "wholesale_membership.updated_at", ["status = active"], ["pending", "suspended", "cancelled", "expired"], "Refunds do not apply.", "Membership cancellation is a source state.", ["PLATFORM", "VIP_ACCOUNT"], "vip_active_memberships", ["status"]),
