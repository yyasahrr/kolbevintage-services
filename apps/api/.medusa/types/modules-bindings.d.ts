...
import type Account from '../../src/modules/account'
import type Supplier from '../../src/modules/supplier'
import type PurchaseOrder from '../../src/modules/purchase-order'
import type Wholesale from '../../src/modules/wholesale'
import type Retail from '../../src/modules/retail'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'account': InstanceType<(typeof Account)['service']>,
    'supplier': InstanceType<(typeof Supplier)['service']>,
    'purchase_order': InstanceType<(typeof PurchaseOrder)['service']>,
    'wholesale': InstanceType<(typeof Wholesale)['service']>,
    'retail': InstanceType<(typeof Retail)['service']>
  }
}