 ...
 * journal idx 45, the four 0043 queue indexes + the 0044 permission CHECK +
 * the 0045 suspicious-flag table).
 */
...
describe("Phase 5.11-D10 static guards", () => {
  ...
  it("D10.7 pins the schema shape: 199 tables, journal idx 45", () => {
