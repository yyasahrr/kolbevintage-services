 ...
 *
 * Verifies:
 * 1. Schema & Migration Integrity (158 tables, 30 migrations, snapshot consistency after Phase 5.5 foundation).
...
describe("Phase 5.3 — Checkpoint A: Notification Templates & Preferences", () => {
  ...
  it("1. Schema & Migration Integrity: 158 tables, migrations through 0029 applied", async () => {
    ...
    expect(Number(rows.rows[0].count)).toBe(158);
  });
