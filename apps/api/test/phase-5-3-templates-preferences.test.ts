...
describe("Phase 5.3 — Checkpoint A: Notification Templates & Preferences", () => {
  ...
  it("1. Schema & Migration Integrity: 199 tables, migrations through 0046 applied", async () => {
    ...
    expect(Number(rows.rows[0].count)).toBe(199); // 0046 adds replay columns/index only
  });
