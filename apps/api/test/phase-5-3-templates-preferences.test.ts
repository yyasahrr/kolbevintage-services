 ...
 *
 * Verifies:
 * 1. Schema & Migration Integrity (155 tables, 29 migrations, snapshot consistency after Phase 5.4).
...
describe("Phase 5.3 — Checkpoint A: Notification Templates & Preferences", () => {
  ...
  it("1. Schema & Migration Integrity: 155 tables, migrations through 0028 applied", async () => {
    ...
    expect(Number(rows.rows[0].count)).toBe(155);
  });
