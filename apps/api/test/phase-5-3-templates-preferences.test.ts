 ...
 *
 * Verifies:
 * 1. Schema & Migration Integrity (142 tables, 28 migrations, snapshot consistency).
...
describe("Phase 5.3 — Checkpoint A: Notification Templates & Preferences", () => {
  ...
  it("1. Schema & Migration Integrity: 142 tables, migration 0027 applied", async () => {
    ...
    expect(Number(rows.rows[0].count)).toBe(142);
  });
