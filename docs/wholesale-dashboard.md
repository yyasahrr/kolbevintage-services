...
| مسیر | ناحیه | مخاطب |
|---|---|---|
| `#/` | فروشگاه (صفحه اول) | عموم مشتریان |
| `#/supplier-apply` | فرم درخواست همکاری | تأمین‌کننده بالقوه |
| `#/partner` | پورتال تأمین‌کننده | تأمین‌کننده تأییدشده |
| `#/admin/*` | پنل عملیات کلبه وینتیج | تیم داخلی شما |
