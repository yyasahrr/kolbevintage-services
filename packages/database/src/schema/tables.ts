...
export const qualityInspection = pgTable(
  ...
  (table) => [
    ...
    check("quality_inspection_arithmetic_invariant", sql.raw(`"sample_size" = "accepted_units" + "defect_units" + "rework_units" + "rejected_units"`)),
...
export const productionLotTrace = pgTable(
  ...
  (table) => [
    ...
    check("production_lot_trace_target_present", sql.raw(`("trace_type" = 'purchase_order_item' AND "purchase_order_item_id" IS NOT NULL) OR ("trace_type" = 'variant' AND "variant_id" IS NOT NULL) OR ("trace_type" = 'source_lot' AND "source_lot_id" IS NOT NULL)`)),
...
export const productionRecallScope = pgTable(
  ...
  (table) => [
    ...
    check("production_recall_scope_target_present", sql.raw(`"lot_id" IS NOT NULL OR "purchase_order_item_id" IS NOT NULL OR "variant_id" IS NOT NULL`)),
