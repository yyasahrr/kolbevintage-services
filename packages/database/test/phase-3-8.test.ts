...
describe("فاز ۳.۸ — Legacy Removal & Clean Architecture", () => {
  ...
  it("194 جدول پس از افزودن Promotions/Commercial Engine به مرز Phase 5.7، در کنار همهٔ دامنه‌های قبلی", async () => {
    const { rows } = await withClient(DB, (client) =>
    ...
    // The Phase 5.7 commercial boundary adds 8 promotions-owned tables to the 186-table Phase 5.6 schema.
